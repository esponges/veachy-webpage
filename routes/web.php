...
Route::post('/inventory/store', 'ProductController@store')->name('product.store')->middleware('auth');
Route::get('/inventory/gallery', 'ProductController@getGallery')->name('product.gallery')->middleware('auth');
