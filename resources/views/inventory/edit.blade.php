...
<div class="container" style="margin-top:150px;">
    ...
    <div class="form group">
        ...
        {{ Form::text('name', $product->name,['class'=>'form-control', 'placeholder' => 'Inserta nombre'])}}
    </div>
    <div class="form group">
        {{ Form::label('description', 'Descripción')}} <br>
        {{ Form::textarea('description', $product->description,['class'=>'form-control', 'placeholder' => 'Color - talla'])}}
    </div>
    <div class="form group">
    ...
    <div class="form group">
        ...
        {{ Form::text('disponibilidad', $product->disponibilidad,['class'=>'form-control', 'placeholder' => '0 = agotado, 1 = disponible'])}}
    </div>
    <div class="form group">
        {{ Form::label('type', 'Tipo')}} <br>
        {{ Form::text('type', $product->type,['class'=>'form-control', 'placeholder' => '1 = bikinis, 2 = salidas, 3 = enteros, 4 = subtipo'])}}
    </div>
    <div class="form group">
        {{ Form::label('total_fotos', 'Total fotos')}} <br>
        {{ Form::text('total_fotos', $product->total_fotos,['class'=>'form-control', 'placeholder' => 'total fotos en número'])}}
    </div>
    {{-- <div class="form group">
