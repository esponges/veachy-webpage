<head>
  ...
  <header class="site-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-4 site-logo" data-aos="fade"><a href="/"><em>Veachy Swimwear</em></a></div>
        <div class="col-8">
        	@auth
        		@if (auth()->user()->role == 1)
                ...
                <div class="row full-height align-items-center">
                  <div class="col-md-6">
                    <ul class="list-unstyled menu">
                      ...
                      <li><a href="https://www.instagram.com/veachy_swimwear">Instragram</a><span class="fa fa-instagram"></span></li>
                      <li><a href="https://www.facebook.com/veachyswimwearoficial">Facebook</a><span class="fa fa-facebook"></span></li>
                  ...
                  <div class="col-md-6 extra-info">
                    <div class="row">
                      <div class="col-md-6 mb-5">
                        <h3>Showroom</h3>
                        <p><em>Pink Girls Showroom</em> <br> Av. S. Bach 4930, Prados Guadalupe, <br> Zapopan Jalisco</p>
                      ...
                      <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li><a href="https://www.facebook.com/veachyswimwearoficial">Facebook</a></li>
    ...
    <a
        ...
        class="material-icons floating-btn-ig">
        <span class="fa fa-instagram"></span>
    </a>
    <a
        href="https://wa.me/5213323633343"
        class="material-icons floating-btn-whats"
    ...
    <div class="container">
      <div class="row mb-4">
        ...
        <div class="col-md-3 mb-5 pr-md-5 contact-info">
          <p><span class="d-block">Showroom:</span> <span> Pink Girls Showroom<br> Av. S. Bach 4930<br> Prados Guadalupe<br> Zapopan, Jal</span></p>
